...
import { randInt, addMat } from '../utils.js';
import { renderHunt } from '../ui/hunt.js';

/* ---------- HUNT SETUP ---------- */

export function startHunt(monsterId, missionKey){
  ...
  setHunt({ monster, pendingMove:null, turnCount:0, sandstormActive:false, playerGuardedThisRound:false, recoveryWindow:false, log:[], over:false, missionKey: missionKey || null });
