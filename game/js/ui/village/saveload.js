  ...
  return `
    <div class="panel">
      ...
      <p style="font-size:12px; color:var(--text-dim); margin:0 0 10px;">
        Generates a portable save code (your gear, materials, goldcoin, and stats). Copy it somewhere safe —
    ...
    <div class="panel">
      <h2>New game</h2>
      <p style="font-size:12px; color:var(--text-dim); margin:0 0 10px;">Wipes goldcoin, gear, and materials back to a fresh Hunter's Blade and Cloth Vest.</p>
